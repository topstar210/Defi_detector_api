...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        @include('layout.sidebar', ['status' => 'token'])
        <!--End sidebar-wrapper-->
                    ...
                    <div class="card" style="margin-bottom: 0px !important;">
                        <div class="card-body" style="padding: 0px !important">
                            ...
                            <ul class="nav nav-tabs nav-tabs-primary top-icon nav-justified">
                                <li class="nav-item">
                                    <a href="dapps" class="nav-link"> <span class="hidden-xs" style="font-size:20px;">ROI Dapp & Miner</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="token" class="nav-link active"> <span class="hidden-xs" style="font-size:20px;">Token</span></a>
                                </li>
                            </ul>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped">
                                                <thead>
                                                    ...
                                                    <th scope="col" style="padding-right:5px !important;padding-left:5px !important;text-align:center;vertical-align:middle;">Price</th>
        ...
        <!--Start footer-->
        @include('layout.footer', ['status' => 'token'])
        <!--End footer-->
