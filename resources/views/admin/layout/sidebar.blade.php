...
<div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
    <div class="brand-logo" style="text-align:left !important;padding-left: 20px; !important">
    ...
    <ul class="sidebar-menu do-nicescrol">
        ...
        <li>
            @endif
            <a href="/admin/adsmanage">
                <i class="zmdi zmdi-balance"></i> <span>ADS manage(ROI)</span>
            </a>
        </li>
        @if($status =='adsmanage_token')
        <li class="active">
            @else
        <li>
            @endif
            <a href="/admin/adsmanage_token">
                <i class="zmdi zmdi-balance"></i> <span>ADS manage(Token)</span>
            </a>
        </li>
