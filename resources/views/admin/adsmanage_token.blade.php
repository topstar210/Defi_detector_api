...
<body class="bg-theme bg-theme1">
    ...
    <div id="wrapper">
        ...
        @include('admin.layout.sidebar', ['status' => 'adsmanage_token'])
        <!--End sidebar-wrapper-->
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content" style="background-color: rgb(2 28 38);">
                                            ...
                                            <div class="modal-body">
                                                <form action="/admin/adsmanage_token/add" id="ads_form" method="POST" enctype="multipart/form-data">
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="form-row">
    ...
    <!--End wrapper-->
    <script src="../assets/js/adsmanage_token_admin.js"></script>
</body>
